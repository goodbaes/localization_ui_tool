        ...
        builder: (context, state) {
          if (state is LocalizationInitial || state is LocalizationLoading) {
            ...
            final missingEntries = state.entries.where((entry) {
              ...
              return entry.values.containsValue('') || entry.values.length < 2; // Assuming at least 2 locales (en, es)
            }).toList();
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(entry.values.entries.map((e) => '${e.key}: ${e.value.isEmpty ? '[MISSING]' : e.value}').join(', ')),
